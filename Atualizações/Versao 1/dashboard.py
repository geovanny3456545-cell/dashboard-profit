...
from tabs import resumo, operacoes, graficos, calendario, ativos
...
# --- NAVIGATION ---
tab_options = ["Resumo", "Operações", "Gráficos", "Ativos", "Calendário"]
if "selected_main_tab" not in st.session_state: st.session_state.selected_main_tab = "Resumo"
